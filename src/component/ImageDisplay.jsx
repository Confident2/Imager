...
import { FaHeart, FaPlus } from 'react-icons/fa'; // Import the love and plus icons from react-icons library
    ...
    <div className="w-full max-w-7xl columns-4  gap-3px gap-5  pt-2 pb-8 mx-auto mb-10 ">
      {imageData.images.map(({ id, description, author, url, tags }) => (
        <div key={id} className="relative">
          <img src={url} alt={description} className="w-full h-full object-cover mb-3" />
